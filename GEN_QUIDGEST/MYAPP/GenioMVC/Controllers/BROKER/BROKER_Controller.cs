...
// USE /[MANUAL TRA MANUAL_CONTROLLER BROKER]/
		...
		/// <summary>
		/// Recalculate formulas of the "F_broke" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_F_broke([FromBody]F_broke_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "broker",
				(primaryKey) => Models.Broker.Find(primaryKey, UserContext.Current, "FF_BROKE"),
