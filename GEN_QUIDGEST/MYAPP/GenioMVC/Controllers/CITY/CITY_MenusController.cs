...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_TRA_MENU_41 = new NavigationLocation("CITIES41573", "TRA_Menu_41", "City") { vueRouteName = "menu-TRA_41" };


		//
		// GET: /City/TRA_Menu_41
