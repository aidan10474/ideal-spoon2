...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_TRA_MENU_71 = new NavigationLocation("CONTACTS55742", "TRA_Menu_71", "Contact") { vueRouteName = "menu-TRA_71" };


		//
		// GET: /Contact/TRA_Menu_71
