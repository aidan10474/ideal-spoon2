...
namespace GenioMVC.ViewModels.Photo_album
{
	public class F_photo_album_ViewModel : FormViewModel<Models.Photo_album>, IPreparableForSerialization
	{
		...
		public override void LoadPartial(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			Load_F_photo_album__property__title(qs, lazyLoad);
...
// USE /[MANUAL TRA VIEWMODEL_DESTROY F_PHOTO_ALBUM]/
		...
		/// <param name="qs"></param>
		/// <param name="lazyLoad">Lazy loading of dropdown items</param>
		public void Load_F_photo_album__property__title(NameValueCollection qs, bool lazyLoad = false)
		{
			bool f_photo_album__property__titleDoLoad = true;
			CriteriaSet f_photo_album__property__titleConds = CriteriaSet.And();
			{
				...
				{
					f_photo_album__property__titleConds.Equal(CSGenioAproperty.FldCodproperty, hValue);
			...
			if (lazyLoad)
			{
				...
				FillDependant_F_photo_albumTablePropertyTitle(lazyLoad);
				return;
			}

			if (f_photo_album__property__titleDoLoad)
			{
				...
				f_photo_album__property__titleConds.SubSet(search_filters);
...
// USE /[MANUAL TRA OVERRQ F_PHOTO_ALBUM_PROPERTYTITLE]/
				...
				*/
				if (Navigation.checkFormMode("property", FormMode.New) || Navigation.checkFormMode("property", FormMode.Duplicate))
					f_photo_album__property__titleConds.SubSet(CriteriaSet.Or()
				...
				TablePropertyTitle.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Property(m_userContext, r, true, _fieldsToSerialize_F_PHOTO_ALBUM__PROPERTY__TITLE));
				...
				FillDependant_F_photo_albumTablePropertyTitle();
			}
		}
		...
		public ConcurrentDictionary<string, object> GetDependant_F_photo_albumTablePropertyTitle(string PKey)
		{
		...
		/// </summary>
		/// <param name="lazyLoad">Lazy loading of dropdown items</param>
		public void FillDependant_F_photo_albumTablePropertyTitle(bool lazyLoad = false)
		{
			var row = GetDependant_F_photo_albumTablePropertyTitle(this.ValCodproperty);
			try
			{
		...
		protected override object GetViewModelValue(string identifier, object modelValue)
		{
			...
			{
				"photo_album.codproperty" => ViewModelConversion.ToString(modelValue),
