...
{
	public class TRA_Menu_621_ViewModel : MenuListViewModel<Models.City>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<TRA_Menu_621_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "96331430-deb5-4957-9028-e3c7410b0df0";
		...
		{
// USE /[MANUAL TRA LIST_LIMITS 621]/
		...
		public TRA_Menu_621_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="TRA_Menu_621_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public TRA_Menu_621_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public TRA_Menu_621_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<TRA_Menu_621_RowViewModel>();
			...
			{
				// EPH
				crs = Models.City.AddEPH<CSGenioAcity>(ref u, crs, "ML621");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.City.AddEPH<CSGenioAcity>(ref u, null, "ML621"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcity> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet tra_menu_621Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(tra_menu_621Conds);
			tra_menu_621Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL TRA OVERRQ 621]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcity>(m_userContext, false, ref tra_menu_621Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML621", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL TRA OVERRQLSTEXP 621]/
...
// USE /[MANUAL TRA OVERRQLIST 621]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcity.GetInformation(), QMVC_POS_RECORD, sorts, tra_menu_621Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAcity> listing = Models.ModelBase.Where<CSGenioAcity>(m_userContext, distinct, tra_menu_621Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML621", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapTRA_Menu_621(listing);
		...
		private List<TRA_Menu_621_RowViewModel> MapTRA_Menu_621(ListingMVC<CSGenioAcity> Qlisting)
		{
			List<TRA_Menu_621_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRA_Menu_621(row));
					i++;
				}
			}
		...
		/// to a TRA_Menu_621_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private TRA_Menu_621_RowViewModel MapTRA_Menu_621(CSGenioAcity row)
		{
			var model = new TRA_Menu_621_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL TRA VIEWMODEL_CUSTOM TRA_MENU_621]/
