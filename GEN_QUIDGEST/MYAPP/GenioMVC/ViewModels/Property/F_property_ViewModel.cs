...
namespace GenioMVC.ViewModels.Property
{
	public class F_property_ViewModel : FormViewModel<Models.Property>, IPreparableForSerialization
	{
		...
		/// </summary>
		[ValidateSetAccess]
		public decimal? ValBuildingage { get; set; }
		/// <summary>
		...
		public override void MapFromModel(Models.Property m)
		{
			...
			try
			{
				...
				ValBuildingage = ViewModelConversion.ToNumeric(m.ValBuildingage);
		...
		public override void MapToModel(Models.Property m)
		{
			...
			try
			{
				...
				*/
				...
				m.ValBuildingage = ViewModelConversion.ToNumeric(ValBuildingage);
			}
			catch (Exception)
			{
...
// USE /[MANUAL TRA VIEWMODEL_DESTROY F_PROPERTY]/
		...
		public void Load_F_property__broker__name(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (lazyLoad)
			{
				...
				{
					this.ValCodagent = Navigation.GetStrValue("RETURN_broker");
...
// USE /[MANUAL TRA OVERRQ F_PROPERTY_BROKERNAME]/
				...
				*/
				...
				TableBrokerName.List = new SelectList(TableBrokerName.Elements.ToSelectList(x => x.ValName, x => x.ValCodbroker,  x => x.ValCodbroker == this.ValCodagent), "Value", "Text", this.ValCodagent);
		...
		public void FillDependant_F_propertyTableBrokerName(bool lazyLoad = false)
		{
			...
			try
			{
				...
				TableBrokerName.Selected = this.ValCodagent;
			}
			catch (Exception ex)
			{
...
// USE /[MANUAL TRA OVERRQ F_PROPERTY_CITYCITY]/
		...
		protected override object GetViewModelValue(string identifier, object modelValue)
		{
			return identifier switch
			{
				...
				"property.buildingage" => ViewModelConversion.ToNumeric(modelValue),
