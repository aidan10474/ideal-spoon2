...
namespace GenioMVC.ViewModels.Property
{
	public class F_property_ViewModel : FormViewModel<Models.Property>, IPreparableForSerialization
	{
		...
		/// <summary>
		/// Title: "Price 0000000000,00" | Type: "$"
		/// </summary>
		...
		public string ValPrimary_property { get; set; }
		...
		public override void MapFromModel(Models.Property m)
		{
			...
			try
			{
				...
				ValPrimary_property = ViewModelConversion.ToString(m.ValPrimary_property);
			}
			catch (Exception)
			{
		...
		public override void MapToModel(Models.Property m)
		{
			...
			try
			{
				...
				m.ValPrimary_property = ViewModelConversion.ToString(ValPrimary_property);
			}
			catch (Exception)
			{
			...
			try
			{
				...
				switch (fullFieldName)
				{
					...
					case "property.price":
						...
						break;
					case "property.primary_property":
						this.ValPrimary_property = ViewModelConversion.ToString(_value);
						break;
					default:
...
// USE /[MANUAL TRA OVERRQ F_PROPERTY_BROKERNAME]/
		...
		protected override object GetViewModelValue(string identifier, object modelValue)
		{
			...
			{
				"property.broker_fk" => ViewModelConversion.ToString(modelValue),
				...
				"property.primary_property" => ViewModelConversion.ToString(modelValue),
		...
		protected override void SetTicketToImageFields()
		{
			if (ValMain_photo != null)
				ValMain_photo.Ticket = Helpers.Helpers.GetFileTicket(m_userContext.User, CSGenio.business.Area.AreaPROPERTY, CSGenioAproperty.FldMain_photo.Field, null, ValPrimary_property);
		}
