...
public class TRA_Menu_61_RowViewModel : Models.Country
{
	#region Constructors
	...
	public TRA_Menu_61_RowViewModel(UserContext userContext, CSGenioAcountry val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
