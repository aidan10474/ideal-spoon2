...
namespace GenioMVC.Models
{
	public class City : ModelBase
	{
		...
		[ShouldSerialize("City.ValCodcountry")]
		...
		public virtual Country Country
		{
			get
			{
				if (!isEmptyModel && (_country == null || (!string.IsNullOrEmpty(ValCodcountry) && (_country.isEmptyModel || _country.klass.QPrimaryKey != ValCodcountry))))
					_country = Models.Country.Find(ValCodcountry, m_userContext, Identifier, _fieldsToSerialize);
