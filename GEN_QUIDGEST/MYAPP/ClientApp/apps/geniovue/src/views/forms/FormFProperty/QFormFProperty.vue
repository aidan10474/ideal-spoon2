	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row v-if="controls.F_PROPERTY__PROPERTY__ID.isVisible || controls.F_PROPERTY__PROPERTY__SOLD.isVisible">
					<q-col
						...
						<base-input-structure
							v-if="controls.F_PROPERTY__PROPERTY__ID.isVisible"
							class="i-text"
							v-bind="controls.F_PROPERTY__PROPERTY__ID"
							v-on="controls.F_PROPERTY__PROPERTY__ID.handlers"
							:loading="controls.F_PROPERTY__PROPERTY__ID.props.loading"
				...
				<q-row v-if="controls.F_PROPERTY__PSEUD__NEWGRP01.isVisible">
					<q-col v-if="controls.F_PROPERTY__PSEUD__NEWGRP01.isVisible">
						<q-group-box-container
							...
							<q-row v-if="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.isVisible">
								<q-col
									v-if="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.isVisible"
										class="q-image"
										v-bind="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO"
										v-on="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.handlers"
										:loading="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-image
											v-if="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.isVisible"
											v-bind="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.props"
											v-on="controls.F_PROPERTY__PROPERTY__MAIN_PHOTO.handlers" />
									</base-input-structure>
								</q-col>
							</q-row>
							...
							<q-row v-if="controls.F_PROPERTY__PROPERTY__DESCRIPTION.isVisible">
								<q-col
					...
					<q-col v-if="controls.F_PROPERTY__PSEUD__NEWGRP05.isVisible">
						<q-accordion
							...
							<q-accordion-item
								...
								<q-row v-if="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.isVisible">
									<q-col
										v-if="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.isVisible"
										cols="auto">
										<base-input-structure
											v-if="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.isVisible"
											class="i-text"
											v-bind="controls.F_PROPERTY__PROPERTY__BUILDINGAGE"
											v-on="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.handlers"
											:loading="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.props.loading"
											:reporting-mode-on="reportingModeCAV"
											:suggestion-mode-on="suggestionModeOn">
											<q-numeric-input
												v-if="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.isVisible"
												v-bind="controls.F_PROPERTY__PROPERTY__BUILDINGAGE.props"
				...
				<q-row v-if="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.isVisible || controls.F_PROPERTY__PROPERTY__FLOORNUMBER.isVisible || controls.F_PROPERTY__PROPERTY__SOLDDATE.isVisible">
					<q-col
						v-if="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.isVisible"
						cols="auto">
						<base-input-structure
							v-if="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.isVisible"
							class="i-text"
							v-bind="controls.F_PROPERTY__PROPERTY__GROUNDSIZE"
							v-on="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.handlers"
							:loading="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-numeric-input
								v-if="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.isVisible"
								v-bind="controls.F_PROPERTY__PROPERTY__GROUNDSIZE.props"
								@update:model-value="model.ValGroundsize.fnUpdateValue" />
						</base-input-structure>
					</q-col>
					<q-col
						v-if="controls.F_PROPERTY__PROPERTY__FLOORNUMBER.isVisible"
						cols="auto">
						<base-input-structure
							v-if="controls.F_PROPERTY__PROPERTY__FLOORNUMBER.isVisible"
							class="i-text"
							v-bind="controls.F_PROPERTY__PROPERTY__FLOORNUMBER"
							v-on="controls.F_PROPERTY__PROPERTY__FLOORNUMBER.handlers"
							:loading="controls.F_PROPERTY__PROPERTY__FLOORNUMBER.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-numeric-input
								v-if="controls.F_PROPERTY__PROPERTY__FLOORNUMBER.isVisible"
								v-bind="controls.F_PROPERTY__PROPERTY__FLOORNUMBER.props"
								@update:model-value="model.ValFloornumber.fnUpdateValue" />
						</base-input-structure>
					</q-col>
					<q-col
						v-if="controls.F_PROPERTY__PROPERTY__SOLDDATE.isVisible"
						cols="auto">
						<base-input-structure
							v-if="controls.F_PROPERTY__PROPERTY__SOLDDATE.isVisible"
							class="i-text"
							v-bind="controls.F_PROPERTY__PROPERTY__SOLDDATE"
							v-on="controls.F_PROPERTY__PROPERTY__SOLDDATE.handlers"
							:loading="controls.F_PROPERTY__PROPERTY__SOLDDATE.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-date-time-picker
								v-if="controls.F_PROPERTY__PROPERTY__SOLDDATE.isVisible"
								v-bind="controls.F_PROPERTY__PROPERTY__SOLDDATE.props"
	...
	export default {
		...
		data()
		{
			...
			return {
				...
				controls: {
					F_PROPERTY__PROPERTY__ID: new fieldControlClass.NumberControl({
						modelField: 'ValId',
						valueChangeEvent: 'fieldChange:property.id',
						id: 'F_PROPERTY__PROPERTY__ID',
						name: 'ID',
						size: 'small',
					...
					F_PROPERTY__PSEUD__NEWGRP01: new fieldControlClass.GroupControl({
						...
						name: 'NEWGRP01',
						size: 'block',
						label: computed(() => this.Resources.MAIN_INFO40201),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						isCollapsible: false,
						anchored: false,
						directChildren: ['F_PROPERTY__PROPERTY__MAIN_PHOTO', 'F_PROPERTY__PROPERTY__TITLE', 'F_PROPERTY__PROPERTY__PRICE', 'F_PROPERTY__PROPERTY__DESCRIPTION'],
						mustBeFilled: true,
						controlLimits: [
						],
					}, this),
					F_PROPERTY__PROPERTY__MAIN_PHOTO: new fieldControlClass.ImageControl({
						modelField: 'ValMain_photo',
						valueChangeEvent: 'fieldChange:property.main_photo',
						id: 'F_PROPERTY__PROPERTY__MAIN_PHOTO',
						name: 'MAIN_PHOTO',
						size: 'mini',
					...
					F_PROPERTY__BROKER__NAME: new fieldControlClass.LookupControl({
						...
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'F_PROPERTY__PSEUD__NEWGRP04',
						externalCallbacks: {
					...
					F_PROPERTY__PSEUD__NEWGRP03: new fieldControlClass.GroupControl({
					...
					F_PROPERTY__CITY__CITY: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValCodcity',
							dependencyEvent: 'fieldChange:property.codcity'
						},
						dependentFields: () => ({
					...
					F_PROPERTY__PSEUD__NEWGRP02: new fieldControlClass.GroupControl({
						...
						isCollapsible: true,
						anchored: false,
						directChildren: ['F_PROPERTY__PROPERTY__DATECONSTRUCTION', 'F_PROPERTY__PROPERTY__BUILDINGAGE', 'F_PROPERTY__PROPERTY__BUILDINGTYPE', 'F_PROPERTY__PROPERTY__BATHROOMSNUMBER', 'F_PROPERTY__PROPERTY__TYPOLOGY', 'F_PROPERTY__PROPERTY__SIZE'],
						controlLimits: [
						],
					}, this),
					...
					F_PROPERTY__PROPERTY__BUILDINGAGE: new fieldControlClass.NumberControl({
						modelField: 'ValBuildingage',
						valueChangeEvent: 'fieldChange:property.buildingage',
						id: 'F_PROPERTY__PROPERTY__BUILDINGAGE',
						name: 'BUILDINGAGE',
						size: 'medium',
					...
					F_PROPERTY__PROPERTY__GROUNDSIZE: new fieldControlClass.NumberControl({
						modelField: 'ValGroundsize',
						valueChangeEvent: 'fieldChange:property.groundsize',
						id: 'F_PROPERTY__PROPERTY__GROUNDSIZE',
						name: 'GROUNDSIZE',
						size: 'small',
					...
					F_PROPERTY__PROPERTY__FLOORNUMBER: new fieldControlClass.NumberControl({
						modelField: 'ValFloornumber',
						valueChangeEvent: 'fieldChange:property.floornumber',
						id: 'F_PROPERTY__PROPERTY__FLOORNUMBER',
						name: 'FLOORNUMBER',
						size: 'medium',
						label: computed(() => this.Resources.FLOOR_NUMBER26169),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxIntegers: 3,
						maxDecimals: 0,
					...
					F_PROPERTY__PROPERTY__SOLDDATE: new fieldControlClass.DateControl({
						modelField: 'ValSolddate',
						valueChangeEvent: 'fieldChange:property.solddate',
						id: 'F_PROPERTY__PROPERTY__SOLDDATE',
						name: 'SOLDDATE',
						size: 'small',
				...
				dataApi: {
					...
					keys: {
						...
						get broker() { return vm.model.ValCodagent },
