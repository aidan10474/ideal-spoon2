...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		/** The primary key. */
		this.ValPrimary_property = reactive(new modelFieldType.PrimaryKey({
			id: 'ValPrimary_property',
			originId: 'ValPrimary_property',
			area: 'PROPERTY',
			field: 'PRIMARY_PROPERTY',
			description: '',
		}).cloneFrom(values?.ValPrimary_property))
		this.stopWatchers.push(watch(() => this.ValPrimary_property.value, (newValue, oldValue) => this.onUpdate('property.primary_property', this.ValPrimary_property, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValBroker_fk.value, (newValue, oldValue) => this.onUpdate('property.broker_fk', this.ValBroker_fk, newValue, oldValue)))
	...
	static QPrimaryKeyName = 'ValPrimary_property'

	get QPrimaryKey() { return this.ValPrimary_property.value }
	set QPrimaryKey(value) { this.ValPrimary_property.updateValue(value) }
}
