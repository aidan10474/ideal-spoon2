...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			Qfield.FieldDescription = "CODCountry";
			Qfield.FieldSize =  8;
			Qfield.MQueue = false;
			Qfield.CavDesignation = "CODCOUNTRY13783";
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("property", new String[] {"codcity"}, DeleteProc.NA);

			// Mother Relations
			//------------------------------
			info.ParentTables = new Dictionary<string, Relation>();
			info.ParentTables.Add("country", new Relation("TRA", "tracity", "city", "codcity", "codcountry", "TRA", "tracountry", "country", "codcountry", "codcountry"));
		}
		...
		/// <summary>Field : "CODCountry" Tipo: "CE" Formula:  ""</summary>
		public static FieldRef FldCodcountry { get { return m_fldCodcountry; } }
		private static FieldRef m_fldCodcountry = new FieldRef("city", "codcountry");
