...
namespace CSGenio.business
{
	...
	public class ArrayTypology : Array<decimal>
	{
		...
		protected override Dictionary<decimal, ArrayElement> LoadDictionary()
		{
			...
			{
				{ E_1_1, new ArrayElement() { ResourceId = "NO_BEDROOMS23406", HelpId = "", Group = "" } },
				{ E_2_2, new ArrayElement() { ResourceId = "_1_BEDROOM54787", HelpId = "", Group = "" } },
				{ E_3_3, new ArrayElement() { ResourceId = "_2_BEDROOMS32459", HelpId = "", Group = "" } },
				{ E_4_4, new ArrayElement() { ResourceId = "_3_BEDROOMS27305", HelpId = "", Group = "" } },
				{ E_5_5, new ArrayElement() { ResourceId = "MORE43445", HelpId = "", Group = "" } },
			};
		}
